document.addEventListener('DOMContentLoaded', () => {
  ...
  window.openServiceModal = function(packageKey) {
    ...
    heroImg.style.backgroundImage = `url('${data.heroBg}')`;
    durationVal.textContent = data.duration;
    priceSmVal.textContent = data.priceSm;
    priceLgVal.textContent = data.priceLg;
